  ...
  const handleBlowOut = () => {
    ...
    const interval = setInterval(() => {
      ...
      confetti({
        ...defaults,
        particleCount,
        colors: ['#6FB8B8', '#CFE8E1', '#E8F2EF', '#FFFFFF'],
    ...
    <div className="celebration-container">
      <style>{`
        ...
        .cake-tier {
          ...
          box-shadow: 0 4px 8px rgba(49, 68, 74, 0.05), inset 0 2px 2px rgba(255,255,255,0.7);
        ...
        .candle-body {
          width: 8px;
          height: 35px;
          background: linear-gradient(to right, var(--mint-blue) 50%, #5AA1A1 50%);
          border-radius: 2px;
          z-index: 5;
          margin-bottom: -1px;
          position: relative;
      ...
      <div className="cake-wrapper" onClick={handleBlowOut}>
        ...
        <div className="cake-tier tier-1">
          <div className="sprinkles-container">
            <div className="sprinkle" style={{ top: '15px', left: '20px', background: '#CFE8E1', transform: 'rotate(20deg)' }}></div>
            <div className="sprinkle" style={{ top: '25px', left: '50px', background: '#6FB8B8', transform: 'rotate(-40deg)' }}></div>
            <div className="sprinkle" style={{ top: '10px', left: '80px', background: '#CFE8E1', transform: 'rotate(10deg)' }}></div>
            <div className="sprinkle" style={{ top: '30px', left: '90px', background: '#E8F2EF', transform: 'rotate(45deg)' }}></div>
          </div>
        </div>
        ...
        <div className="cake-tier tier-2">
          <div className="sprinkles-container">
            ...
            <div className="sprinkle" style={{ top: '40px', left: '60px', background: '#6FB8B8', transform: 'rotate(50deg)' }}></div>
            <div className="sprinkle" style={{ top: '15px', left: '100px', background: '#FFFFFF', transform: 'rotate(10deg)' }}></div>
            <div className="sprinkle" style={{ top: '35px', left: '140px', background: '#E8F2EF', transform: 'rotate(-30deg)' }}></div>
          </div>
        </div>
        ...
        <div className="cake-tier tier-3">
          <div className="sprinkles-container">
            ...
            <div className="sprinkle" style={{ top: '15px', left: '80px', background: '#CFE8E1', transform: 'rotate(-10deg)' }}></div>
            <div className="sprinkle" style={{ top: '45px', left: '120px', background: '#FFFFFF', transform: 'rotate(40deg)' }}></div>
            <div className="sprinkle" style={{ top: '25px', left: '180px', background: '#CFE8E1', transform: 'rotate(-35deg)' }}></div>
            <div className="sprinkle" style={{ top: '50px', left: '200px', background: '#E8F2EF', transform: 'rotate(15deg)' }}></div>
          </div>
        </div>
