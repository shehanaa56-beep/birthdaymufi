...
const DaisyIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="50" cy="50" r="14" fill="#FFEAA0" />
  </svg>
);
...
// Yellow/Orange Ribbon Bow SVG (using theme colors)
const BowIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 100 80" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M40 30C20 10 5 15 5 40C5 65 25 50 45 40C45 40 40 30 40 30Z" fill="#FFEAA0" stroke="#EAD575" strokeWidth="2.5" />
    <path d="M60 30C80 10 95 15 95 40C95 65 75 50 55 40C55 40 60 30 60 30Z" fill="#FFEAA0" stroke="#EAD575" strokeWidth="2.5" />
    <circle cx="50" cy="35" r="8" fill="#EAD575" stroke="#B59929" strokeWidth="2.5" />
    <path d="M45 40C35 60 25 80 25 80L35 80L50 50L45 40Z" fill="#EAD575" stroke="#B59929" strokeWidth="2.5" />
    <path d="M55 40C65 60 75 80 75 80L65 80L50 50L55 40Z" fill="#EAD575" stroke="#B59929" strokeWidth="2.5" />
  </svg>
);
    ...
    <div className="gift-reveal-page">
      <style>{`
        .gift-reveal-page {
          width: 100vw;
          min-height: 100vh;
          background-color: var(--mint-blue); /* Updated to theme's blue/mint */
          background-image: 
        ...
        .birthday-text {
          ...
          color: #FFFFFF;
          letter-spacing: 4px;
          /* White outline effect + dark teal block shadow matching theme */
          text-shadow: 
            -1px -1px 0 #FFF, 1px -1px 0 #FFF, -1px 1px 0 #FFF, 1px 1px 0 #FFF,
            4px 4px 0px var(--satin-ribbon);
        ...
        .next-btn {
          background-color: var(--satin-ribbon); /* Theme dark teal */
