...
const GiftBow = () => (
  ...
  >
    {/* Loops */}
    <path d="M50 40 C35 15 15 15 15 32 C15 48 35 43 50 40" fill="rgba(255, 232, 144, 0.95)" stroke="var(--mint-blue)" strokeWidth="1.2" />
    <path d="M50 40 C65 15 85 15 85 32 C85 48 65 43 50 40" fill="rgba(255, 232, 144, 0.95)" stroke="var(--mint-blue)" strokeWidth="1.2" />

    {/* Tails */}
    <path d="M50 40 C46 55 35 70 20 74" fill="none" stroke="rgba(255, 232, 144, 0.95)" strokeWidth="4.5" strokeLinecap="round" />
    <path d="M50 40 C46 55 35 70 20 74" fill="none" stroke="var(--mint-blue)" strokeWidth="1" strokeLinecap="round" />

    <path d="M50 40 C54 55 65 70 80 74" fill="none" stroke="rgba(255, 232, 144, 0.95)" strokeWidth="4.5" strokeLinecap="round" />
